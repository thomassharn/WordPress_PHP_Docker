    ...
    <div class="row container-fluid" action="" id="account-info-form">
        <div class="col-md-8 mt-4 ml-5">
            <div class="p-4 shadow-cstm bg-white rounded">
                <h4 class="form-head"><?php _e('Thank you for registering with miniOrange', 'miniorange-saml-20-single-sign-on'); ?></h4>
                    ...
                    <tr>
                        <td>
                            <form name="f1" method="post" action="" id="mo_saml_goto_login_form">
                                ...
                                <input type="submit" value="<?php _e('Switch Account', 'miniorange-saml-20-single-sign-on'); ?>" class="mo-saml-bs-btn btn-cstm" />
                            </form>
                        </td>
                        <td>
                            <a href="<?php echo add_query_arg(array('tab' => 'licensing'), htmlentities($_SERVER['REQUEST_URI'])); ?>"><input type="button" class="mo-saml-bs-btn btn-cstm" value="<?php _e('Check Licensing Plans', 'miniorange-saml-20-single-sign-on'); ?>" /></a>
                        </td>
                    </tr>
                </table>
                ...
                <div class="col-md-5 mt-5 rounded reg-form">
                    <form name="f" method="post" action="">
                        ...
                        <div class="row mt-4 text-center">
                            <div class="col-md-12">
                                <input type="submit" name="submit" value="Register" class="mo-saml-bs-btn btn-cstm rounded w-176 mr-0" id="mo_saml_reg_btn">
                                <input type="submit" name="submit" value="Login" class="mo-saml-bs-btn btn-cstm rounded w-176 mr-0" id="mo_saml_reg_login_btn">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
