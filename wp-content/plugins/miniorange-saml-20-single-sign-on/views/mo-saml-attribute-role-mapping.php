    ...
    <div class="p-4 shadow-cstm bg-white rounded">
        ...
        <div class="row prem-info mt-5 d-block">
            <div class="prem-icn nameid-prem-img"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                <p class="nameid-prem-text">The basic attributes are configurable in Standard, Premium, Enterprise and All-Inclusive plans. Custom Attributes are configurable in Premium and higher plans. <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="text-warning">Click here to upgrade</a></p>
            </div>
            <div class="row align-items-top">
                <div class="col-md-3">
