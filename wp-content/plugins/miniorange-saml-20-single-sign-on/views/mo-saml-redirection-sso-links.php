    ...
    <?php if (mo_saml_is_customer_registered_saml()) { ?>
        <div class="row container-fluid" id="redir-sso-tab-form">
            <div class="col-md-8 mt-4 ml-5">
                <?php
                mo_saml_display_sso_button_config($add_sso_button_wp);
...
function mo_saml_display_sso_button_config($add_sso_button_wp)
{
    ...
    <div class="p-4 shadow-cstm bg-white rounded">
        ...
        <div class="prem-info mt-4">
            <div class="prem-icn sso-btn-prem-img"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                <p class="prem-info-text sso-btn-prem-text">Customization of SSO/Login button is available in Premium, Enterprise and All-Inclusive versions of the plugin <a href="" class="text-warning">Click here to upgrade</a></p>
            </div>
...
?>
    <div class="p-4 shadow-cstm bg-white rounded mt-4">
        ...
        <div class="prem-info mt-4">
            <div class="prem-icn auto-redir-prem-img"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                <p class="prem-info-text auto-redir-text">Auto-Redirection from site is configurable in Standard, Premium, Enterprise and All-Inclusive versions of the plugin <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="text-warning">Click here to upgrade</a></p>
            </div>
...
?>
    <div class="p-4 shadow-cstm bg-white rounded mt-4">
        ...
        <div class="prem-info mt-4">
            <div class="prem-icn auto-redir-prem-img"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                <p class="prem-info-text auto-redir-wp-text">Auto-Redirection from WordPress is configurable in Standard, Premium, Enterprise and All-Inclusive versions of the plugin <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="text-warning">Click here to upgrade</a></p>
            </div>
...
?>
    <div class="p-4 shadow-cstm bg-white rounded mt-4">
        ...
        <div class="prem-info mt-4">
            <div class="prem-icn auto-redir-prem-img"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                <p class="prem-info-text shortcode-text">These options are configurable in the Standard, Premium, Enterprise and All-Inclusive version of the plugin. <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="text-warning">Click here to upgrade</a></p>
            </div>
            <div class="row align-items-top">
                <div class="col-md-6">
