    ...
    <form width="98%" method="post" id="mo_saml_update_idp_settings_form" action="">
        ...
        <div class="p-4 shadow-cstm bg-white rounded mt-4">
            ...
            <div class="row align-items-center mt-5 mt-4 rounded prem-info">
                <div class="prem-icn"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                    <p class="prem-info-text">Configurable ACS URL / SP Base URL available in the <b>Paid</b> versions of the plugin. <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="text-warning">Click here to upgrade</a></p>
                </div>
                <div class="col-md-3">
    ...
    <div class="p-4 shadow-cstm bg-white rounded">
        ...
        <div class="row align-items-baseline">
            ...
            <div class="col-md-6 text-right">
                <a href="https://plugins.miniorange.com/wordpress-saml-guides" class="mo-saml-bs-btn btn-cstm ml-3" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
            ...
            <tr>
                ...
                <td>
                    <table class="w-100">
                        <tbody>
                        <tr>
                            <td><a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="mo-saml-bs-btn btn-cstm ml-3">Premium</a></td>
                            <td class="text-right"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="20px">&nbsp;</td>
                        </tr>
                        </tbody>
                    </table>
                </td>
