                ...
                <form method="post" action="">
                    ...
                    <div id="mo-saml-idp-manual-tab" class="mo-saml-tab-content">
                        ...
                        <div class="row align-items-top mt-2">
                            ...
                            <div class="col-md-9">
                                <input type="submit" class="mo-saml-bs-bs-btn btn-cstm rounded mt-3 mr-3 w-176" name="submit" value="Save">
                                <input type="button" class="mo-saml-bs-bs-btn btn-cstm rounded mt-3 w-176" id="test_config" <?php if (!mo_saml_is_sp_configured() || !get_option('saml_x509_certificate') || !mo_saml_is_openssl_installed())
                        ...
                        <div class="row align-items-top mt-2">
                            <div class="col-md-3"></div>
                            <div class="col-md-9">
                                <input type="button" class="mo-saml-bs-bs-btn btn-cstm rounded mt-3 w-372" name="saml_request" id="export-import-config" <?php if (!mo_saml_is_sp_configured() || !get_option('saml_x509_certificate')) {
                                                                                                                                                echo 'disabled';
                ...
                <div id="mo-saml-upload-idp-tab" class="mo-saml-tab-content">
                    <form name="saml_upload_metadata_form" method="post" id="saml_upload_metadata_form" action="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=save'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="row align-items-center mt-5">
                            ...
                            <div class="col-md-4">
                                <button type="button" value="Upload" onclick="checkMetadataFile();" class="mo-saml-bs-bs-btn btn-cstm rounded d-flex align-items-center"><svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <div class="row align-items-center mt-5">
                            ...
                            <div class="col-md-4">
                                <button type="button" value="Fetch" onclick="checkMetadataUrl();" class="mo-saml-bs-bs-btn btn-cstm rounded d-flex align-items-center"><svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
